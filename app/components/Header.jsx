    ...
    return (
        <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
            ...
            <motion.h3 className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'
                ...
                Hi I'm Rishibalan Panneerselvam <Image src={assets.hand_icon} alt='hand' className='w-6' /></motion.h3>
            ...
            <motion.p className='max-w-2xl mx-auto font-Ovo' initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.7 }}>
                Angular Frontend Developer | SAP Spartacus | React & Next.js | JavaScript | 5 Years Experience
            </motion.p>
            <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
                ...
                <motion.a
                    initial={{ y: 30, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ duration: 0.6, delay: 1.2}}
                    href="/Rishibalan_Panneerselvam.pdf" download className={`px-10 py-3 border rounded-full border-gray-500 flex items-center gap-2 ${isDarkMode ? "dark:bg-white dark:text-black" : ""}`}> My resume
